...
const validateFiles = async () => {
    ...
    // ⚡ Bolt Optimization: Single pass iteration over map entries avoiding Array.from() allocation and early exit
...
const packApp = async () => {
    ...
    try {
        ...
        // ⚡ Bolt Optimization: Use for...of to avoid O(N) Array.from allocation and early exit when found
        for (const [path, file] of filesMap.value.entries()) {
