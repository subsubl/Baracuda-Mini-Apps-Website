...
const validateFiles = async () => {
    ...
    if (!hasAppInfo) {
        ...
        error.value = null;
        // Parse appinfo.spixi
        // ⚡ Bolt Optimization: Use for...of loop on Map iterator instead of Array.from().find()
        // Prevents unnecessary O(N) array allocation and allows early exit, saving memory and CPU.
