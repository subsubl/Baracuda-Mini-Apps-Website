...
const validateFiles = async () => {
    ...
    if (!hasAppInfo) {
        ...
        error.value = null;
        // Parse appinfo.spixi
        // ⚡ Bolt Optimization: Use for...of over map entries instead of Array.from().find()
        // Prevents unnecessary O(N) array allocation and reduces garbage collection pressure
