...
const validateFiles = async () => {
    ...
    if (!hasAppInfo) {
        ...
        error.value = null;
        // Parse appinfo.spixi
        // ⚡ Bolt Optimization: Replace Array.from().find() with a direct for...of loop over map entries
        // This avoids creating an unnecessary O(N) array allocation on memory and garbage collection.
        let appInfoFile = undefined;
