...
// ⚡ Bolt Optimization: Replaced deeply nested ternaries and switch statements within the reactive computed scope with a static O(1) object lookup map.
// This prevents redundant processing cycles when locales change and improves code readability.
const languageMap = {
    "en": "English",
    "es": "Español",
    "pt": "Português",
...
const availableLocales = computed(() => {
    return locales.value.map(i => ({
        ...i,
        name: languageMap[i.code] || "Unknown",
