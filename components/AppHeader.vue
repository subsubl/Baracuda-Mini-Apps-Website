<script>
// ⚡ Bolt Optimization: Moved static O(1) object lookup map outside of reactive scope
// This prevents redundant parsing cycles on every re-evaluation of availableLocales
...
const availableLocales = computed(() => {
    // ⚡ Bolt Optimization: Replaced large nested ternary string and unused switch statement
    // with a clean O(1) property lookup to improve code readability and execution speed
    return locales.value.map(i => ({
        ...i,
        name: LANGUAGE_NAMES[i.code] || "Unknown",
