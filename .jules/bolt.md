...
## 2026-04-25 - [Map Iteration Performance]
**Learning:** Direct iteration over a `Map`'s entries using a `for...of` loop is approximately 3x faster than converting to an array with `Array.from()` for search operations in the Nuxt environment.
